    ...
    return `
      <div class="coupon-admin-row" id="coupon-row-${c.id}">
        <div class="coupon-admin-info">
          <div class="coupon-admin-code">${escAdminHtml(c.code)} ${badge}</div>
          <div class="coupon-admin-detail">${discLabel} · ${minLabel}</div>
        </div>
...
function resetCouponForm() {
  ["coupon-code-input","coupon-value-input","coupon-max-input","coupon-min-input"]
